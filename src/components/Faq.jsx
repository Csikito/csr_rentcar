      ...
      <div className="container m-auto relative px-5">
        ...
        <div className="max-w-[900px] m-auto  faq__shadow z-10 relative scroll__scale">
          <div className="question__box m-auto">
            ...
            >
              <p>
                Credit and debit cards from internationally recognized companies
                (Visa, MasterCard, etc.) are accepted at our branches in Spain.
                Prepaid cards are not accepted. Some car categories require a
          ...
          <div className="question__box m-auto">
            ...
            >
              <p>
                Prepaid Bookings: You'll pay when you book online. Remember that
                although your booking has been paid for, the main driver will
                still be required to have a credit card in their name on
